...
public class SearchServiceImpl implements SearchService {
    ...
    public void upperAlbum(Long albumId) {
        ...
        CompletableFuture<Void> statCompletableFuture = CompletableFuture.runAsync(() -> {
            ...
            //5.1 产生随机数值作为四项统计数值
            int num1 = albumStatVo.getPlayStatNum();
            int num2 = albumStatVo.getCommentStatNum();
            int num3 = albumStatVo.getBuyStatNum();
            int num4 = albumStatVo.getCommentStatNum();
    ...
    public SearchRequest buildDSL(AlbumIndexQuery albumIndexQuery) {
        ...
        if (org.apache.commons.lang3.StringUtils.isNotBlank(order)) {
